...
class CheckSuite(unittest.TestCase):
    ...
    def test_type_mismatch_in_expression_assign_left_float_right_string(self):
        ...
        expect = "Type Mismatch In Expression: BinaryOp(=,Id(x),StringLiteral(string))"
    ...
    def test_type_mismatch_in_expression_assign_left_int_right_float(self):
        ...
        expect = "Type Mismatch In Expression: BinaryOp(=,Id(x),FloatLiteral(12.3))"
    ...
    def test_if_condition_is_boolean_expresion(self):
        ...
        """
        expect = "Type Mismatch In Statement: If(BinaryOp(+,IntLiteral(1),IntLiteral(2)),Block([]),Block([]))"
    ...
    def test_TypeMismatchInStatement_In_main_not_return(self):
        input = """
            int foo(){
                return; // For error
            }
    ...
    def test_Continue_Not_In_Loop_Inside_Outside_For(self):
        input = """
            void main(){
                int x;
                x = 0;
    ...
    def test_Continue_Not_In_Loop_Inside_Outside_do_while(self):
        input = """
            void main(){
                int x,i;
                x = 0;
    ...
    def test_Not_Left_Value_statement_booelean(self):
        input = """
            void main(){
                true = false;
            }
    ...
    def test_Not_Left_Value_statement_left_string(self):
        input = """
            void main(){
                "chi" = 6;
            }
        """
        expect = "Not Left Value: StringLiteral(chi)"
        self.assertTrue(TestChecker.test(input,expect,492))

    def test_Not_Left_Value_statement_variables(self):
        input = """
            void main(){
                int a;
                int b;
    ...
    def test_Not_Left_Value_expression_div(self):
        input = """
            void main(){
                5/6 = false || false;
            }
        """
        expect = "Not Left Value: BinaryOp(/,IntLiteral(5),IntLiteral(6))"
        self.assertTrue(TestChecker.test(input,expect,495))

    def test_Type_Mismatch_In_Expression_exp2_or_operator(self):
        input = """
            void main(){
                int a;
                for(5;a || true;4){
    ...
    def test_No_entry_point_with_multi_function(self):
        input = """
            int main1(){
               if(true){
    ...
    def test_Redeclared_Fuction_with_different_num_param(self):
        input = """
            int foo1(int a,float c){
               return 5;
    ...
    def test_Redeclared_Fuction_two_function(self):
        input = """
            int foo(){
               return 5;
    ...
    def test_No_entry_point_with_multi_function(self):
        input = """
                void main(){}
                int foo(boolean b1, string str1){
                    int i;
                    for (i = 1 ; true; i = i + 1){
